# SkynetAccessibility Scanner: Moodle Plugin
...
## License
SkynetAccessibility Scanner is licensed under the GNU General Public License - see the [LICENSE](LICENSE) file for details.
